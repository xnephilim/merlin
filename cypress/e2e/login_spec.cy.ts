...
describe('The Dashboard', () => {
  ...
  it('supports log in via an imported ShapeShift wallet', () => {
    ...
    cy.getBySel('wallet-native-seed-validation-message').contains(
      translations.en.walletProvider.xnephIlim.import.secretRecoveryPhraseRequired,
    )
    ...
    cy.getBySel('wallet-native-seed-submit-button').click()
    cy.getBySel('wallet-native-seed-validation-message').contains(
      translations.en.walletProvider.xnephIlim.import.secretRecoveryPhraseTooShort,
    )
    ...
    cy.getBySel('wallet-native-seed-submit-button').click()
    cy.getBySel('wallet-native-seed-validation-message').contains(
      translations.en.walletProvider.xnephIlim.import.secretRecoveryPhraseError,
    )
