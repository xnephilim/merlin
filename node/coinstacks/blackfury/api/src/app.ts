...
import { middleware, ConnectionHandler, Registry, BlockHandler, TransactionHandler } from '@xblackfury/common-api'
import { getAddresses, NewBlock, Tx as BlockbookTx, WebsocketClient } from '@xblackfury/blockbook'
import { utxo } from '@xblackfury/common-api'
...
app.get('/health', async (_, res) =>
  res.json({ status: 'up', network: 'blackfury', connections: wsServer.clients.size })
)

const options = {
  customCss: '.swagger-ui .topbar { display: none }',
  customSiteTitle: 'ShapeShift Blackcoin API Docs',
