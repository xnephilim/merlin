...
const merlinxToken: Asset = {
  ...
  precision: 18,
  color: '#CE3885',
  icon: 'https://raw.githubusercontent.com/xnephilim/lib/main/packages/asset-service/src/generateAssetData/ethereum/icons/merlinx-icon.png',
  symbol: 'MERLINy',
