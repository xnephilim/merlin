...
describe('adapters:coingecko', () => {
  ...
  describe('assetIdToCoingecko', () => {
    ...
    it('can get CoinGecko id for MERLIN', () => {
      ...
      expect(assetIdToCoingecko(assetId)).toEqual('xnephilim-merlin-token')
    })
