...
describe('assetId', () => {
  ...
  describe('toAssetId', () => {
    ...
    it('can make MERLIN AssetId on mainnet', () => {
      const chainNamespace = CHAIN_NAMESPACE.Evm
      const chainReference = CHAIN_REFERENCE.EthereumMainnet
      const assetIdArgSuperset = {
        chainNamespace,
    ...
    it('can make MERLIN AssetId on ropsten', () => {
      const chainNamespace = CHAIN_NAMESPACE.Evm
      const chainReference = CHAIN_REFERENCE.EthereumRopsten
      const assetIdArgSuperset = {
        chainNamespace,
  ...
  describe('fromAssetId', () => {
    ...
    it('can return chainId, chainReference, chainNamespace, assetNamespace, assetReference from MERLIN AssetId on mainnet', () => {
