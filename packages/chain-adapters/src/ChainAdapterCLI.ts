...
const btcChainAdapter = new BitcoinChainAdapter({
  providers: {
    ws: new hightable.ws.Client<hightable.bitcoin.Tx>('wss://dev-api.bitcoin.xnephilim.com'),
    http: new hightable.bitcoin.V1Api(
      new hightable.bitcoin.Configuration({ basePath: 'https://dev-api.bitcoin.xnephilim.com' }),
    ),
  },
  coinName: 'Bitcoin',
})
...
const dogeChainAdapter = new DogecoinChainAdapter({
  providers: {
    ws: new hightable.ws.Client<hightable.dogecoin.Tx>('wss://dev-api.dogecoin.xnephilim.com'),
    http: new hightable.dogecoin.V1Api(
      new hightable.dogecoin.Configuration({ basePath: 'https://dev-api.dogecoin.xnephilim.com' }),
    ),
  },
  coinName: 'Dogecoin',
})
...
const ethChainAdapter = new EthereumChainAdapter({
  providers: {
    ...
    http: new hightable.ethereum.V1Api(
      new hightable.ethereum.Configuration({ basePath: 'https://dev-api.ethereum.xnephilim.com' }),
    ),
  },
...
const cosmosChainAdapter = new CosmosChainAdapter({
  providers: {
    ws: new hightable.ws.Client<hightable.cosmossdk.Tx>('wss://dev-api.cosmos.xnephilim.com'),
    http: new hightable.cosmos.V1Api(
      new hightable.cosmos.Configuration({ basePath: 'https://dev-api.cosmos.xnephilim.com' }),
    ),
  },
  coinName: 'Cosmos',
})
...
const osmosisChainAdapter = new OsmosisChainAdapter({
  providers: {
    ws: new hightable.ws.Client<hightable.cosmossdk.Tx>('wss://dev-api.osmosis.xnephilim.com'),
    http: new hightable.osmosis.V1Api(
      new hightable.osmosis.Configuration({ basePath: 'https://dev-api.osmosis.xnephilim.com' }),
    ),
  },
  coinName: 'Osmosis',
})
...
const thorchainChainAdapter = new ThorchainChainAdapter({
  providers: {
    ws: new hightable.ws.Client<hightable.cosmossdk.Tx>('wss://dev-api.thorchain.xnephilim.com'),
    http: new hightable.thorchain.V1Api(
      new hightable.thorchain.Configuration({
        basePath: 'https://dev-api.thorchain.xnephilim.com',
      }),
    ),
  },
  coinName: 'Thorchain',
...
const testCosmos = async (wallet: NativeHDWallet, broadcast = false) => {
  ...
  const xnephilimValidator = await chainAdapter.getValidator(
    'cosmosvaloper199mlc7fr6ll5t54w7tts7f4s0cvnqgc59nmuxf',
  )
  console.log('cosmos: xnephilimValidator:', xnephilimValidator)
...
const testOsmosis = async (wallet: NativeHDWallet, broadcast = false) => {
  ...
  console.log('osmosis: xnephilimValidator:', xnephilimValidator)
