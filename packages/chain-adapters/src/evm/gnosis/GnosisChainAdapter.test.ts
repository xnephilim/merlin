...
import { ASSET_REFERENCE, fromChainId, gnosisAssetId, gnosisChainId } from '@xblackfury/caip'
...
const makeChainAdapterArgs = (overrideArgs?: {
  providers?: { http: hightable.gnosis.V1Api }
  chainId?: EvmChainId
}): ChainAdapterArgs<hightable.gnosis.V1Api> =>
  merge(
    {
      providers: {
        http: {} as hightable.gnosis.V1Api,
        ws: {} as hightable.ws.Client<hightable.gnosis.Tx>,
      },
      rpcUrl: '',
    },
    overrideArgs,
...
describe('GnosisChainAdapter', () => {
  ...
  describe('getFeeData', () => {
    it('should return current network fees', async () => {
      ...
      } as unknown as hightable.gnosis.V1Api
