...
import { ASSET_REFERENCE, gnosisAssetId } from '@xblackfury/caip'
...
export class ChainAdapter extends EvmBaseAdapter<KnownChainIds.GnosisMainnet> {
  ...
  private readonly api: hightable.gnosis.V1Api

  constructor(args: ChainAdapterArgs<hightable.gnosis.V1Api>) {
    super({
      assetId: gnosisAssetId,
      chainId: DEFAULT_CHAIN_ID,
      supportedChainIds: SUPPORTED_CHAIN_IDS,
      defaultBIP44Params: ChainAdapter.defaultBIP44Params,
      parser: new hightable.gnosis.TransactionParser({
        assetId: gnosisAssetId,
