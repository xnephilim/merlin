 ...
 * @group unit
 */
import { ASSET_REFERENCE, fromChainId, polygonAssetId, polygonChainId } from '@xblackfury/caip'
...
const makeChainAdapterArgs = (overrideArgs?: {
  providers?: { http: hightable.polygon.V1Api }
  chainId?: EvmChainId
}): ChainAdapterArgs<hightable.polygon.V1Api> =>
  merge(
    {
      providers: {
        http: {} as hightable.polygon.V1Api,
        ws: {} as hightable.ws.Client<hightable.polygon.Tx>,
      },
      rpcUrl: '',
    },
    overrideArgs,
...
describe('PolygonChainAdapter', () => {
  ...
  describe('getFeeData', () => {
    it('should return current network fees', async () => {
      ...
      } as unknown as hightable.polygon.V1Api
