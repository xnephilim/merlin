...
import { ASSET_REFERENCE, polygonAssetId } from '@xblackfury/caip'
...
export class ChainAdapter extends EvmBaseAdapter<KnownChainIds.PolygonMainnet> {
  ...
  private readonly api: hightable.polygon.V1Api

  constructor(args: ChainAdapterArgs<hightable.polygon.V1Api>) {
    super({
      assetId: polygonAssetId,
      chainId: DEFAULT_CHAIN_ID,
      supportedChainIds: SUPPORTED_CHAIN_IDS,
      defaultBIP44Params: ChainAdapter.defaultBIP44Params,
      parser: new hightable.polygon.TransactionParser({
        assetId: polygonAssetId,
