...
import MERLINX_STAKING_ABI from './abi/merlinxStaking'
import { MERLINX_STAKING_CONTRACT } from './constants'
...
export class Parser implements SubParser<Tx> {
  readonly abiInterface = new ethers.utils.Interface(MERLINX_STAKING_ABI)
  ...
  async parse(tx: Tx): Promise<TxSpecific | undefined> {
    if (!txInteractsWithContract(tx, MERLINX_STAKING_CONTRACT)) return
