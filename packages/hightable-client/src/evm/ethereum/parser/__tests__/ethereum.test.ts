...
import {
  MERLINX_STAKING_CONTRACT,
  SHAPE_SHIFT_ROUTER_CONTRACT,
  UNI_V2_MERLIN_STAKING_REWARDS_V3,
...
import merlinClaim from './mockData/merlinClaim'
import merlinExit from './mockData/merlinExit'
import merlinStake from './mockData/merlinStake'
import merlinxClaimWithdraw from './mockData/merlinxClaimWithdraw'
import merlinxInstantUnstake from './mockData/merlinxInstantUnstake'
import merlinxStake from './mockData/merlinxStake'
import merlinxUnstake from './mockData/merlinxUnstake'
...
const tokenMetadata: evm.TokenMetadata = {
  name: 'Merlinx',
  description: 'The merliniest Merlin',
  media: { url: 'http://merlinx.merlin', type: 'image' },
}
...
describe('parseTx', () => {
        ...
        transfers: [
          {
            type: TransferType.Send,
            from: address,
            to: UNI_V2_MERLIN_STAKING_REWARDS_V3,
            assetId: 'eip155:1/erc20:0x470e8de2ebaef52014a47cb5e6af86884947f08c',
    ...
    it('should be able to parse exit', async () => {
      ...
      const expected: ParsedTx = {
        ...
        transfers: [
          {
            type: TransferType.Receive,
            from: UNI_V2_MERLIN_STAKING_REWARDS_V3,
            to: address,
            assetId: 'eip155:1/erc20:0x470e8de2ebaef52014a47cb5e6af86884947f08c',
  ...
  describe('merlinx', () => {
    ...
    it('should be able to parse instant unstake', async () => {
      const { tx } = merlinxInstantUnstake
