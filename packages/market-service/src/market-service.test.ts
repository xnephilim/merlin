...
import { mockMerlinxMarketData, mockMerlinxPriceHistoryData } from './merlinx/merlinxMockData'
import {
...
const merlinxFindAllMock = jest.fn().mockImplementation(() => mockMerlinxMarketData)
const merlinxFindByAssetIdMock = jest.fn().mockImplementation(() => mockMerlinxMarketData)
const merlinxFindPriceHistoryByAssetIdMock = jest
  .fn()
  .mockImplementation(() => mockMerlinxPriceHistoryData)

jest.mock('./merlinx/merlinx', () => ({
  MerlinxMarketService: jest.fn().mockImplementation(() => {
    return {
      findAll: merlinxFindAllMock,
      findByAssetId: merlinxFindByAssetIdMock,
      findPriceHistoryByAssetId: merlinxFindPriceHistoryByAssetIdMock,
    }
  }),
}))
...
describe('market service', () => {
  ...
  describe('findAll', () => {
    ...
    it('errors if no data found', async () => {
      ...
      merlinxFindAllMock.mockRejectedValueOnce({ error: 'error' })
  ...
  describe('findByAssetId', () => {
    ...
    it('can return null if no data found', async () => {
      ...
      merlinxFindByAssetIdMock.mockRejectedValueOnce({ error: 'error' })
  ...
  describe('findPriceHistoryByAssetId', () => {
    ...
    it('can return null if no data found', async () => {
      ...
      merlinxFindPriceHistoryByAssetIdMock.mockRejectedValueOnce({ error: 'error' })
