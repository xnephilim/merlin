import { Asset, AssetService } from '@xblackfury/asset-service'
import { CHAIN_NAMESPACE, ethAssetId, ethChainId, fromAssetId } from '@xblackfury/caip'
import { bitcoin, ethereum, UtxoBaseAdapter, UtxoChainId } from '@xblackfury/chain-adapters'
...
const {
  ...
  MIDGARD_URL = 'https://dev-indexer.thorchain.xnephilim.com/v2',
  DEVICE_ID = 'device123',
