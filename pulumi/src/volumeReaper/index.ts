...
console.log(figlet.textSync('Hightable Volume Reaper'))

const program = new Command()

program
  .description(
    'A CLI for creating EBS Snapshots for Hightable. This CLI will stop a target StatefulSet, take a snapshot of an attached PVC, start the StatefulSet back up and finally, clean up older backups.'
  )
