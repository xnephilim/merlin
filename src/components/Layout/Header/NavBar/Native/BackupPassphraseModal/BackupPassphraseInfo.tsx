...
export const BackupPassphraseInfo: React.FC<LocationState> = props => {
  ...
  return (
    <SlideTransition>
      ...
      />
      <ModalHeader pt={4}>
        <Text translation={'modals.xnephIlim.backupPassphrase.info.title'} />
      </ModalHeader>
      {!preventClose && <ModalCloseButton />}
      <ModalBody>
        <Text
          color='gray.500'
          translation={'modals.xnephIlim.backupPassphrase.info.description'}
          mb={6}
        />
        <Alert status='info'>
          <AlertIcon />
          <AlertDescription>
            <Text
              color={alertColor}
              translation={'modals.xnephIlim.backupPassphrase.info.warning'}
            />
          </AlertDescription>
        </Alert>
