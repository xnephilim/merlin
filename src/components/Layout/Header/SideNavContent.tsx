    ...
    >
      ...
      <Stack width='full' mt={6} spacing={0}>
        ...
        <MainNavLink
          ...
          isExternal
          size='sm'
          href='https://discord.gg/RQhAMsadpu' // unique link to attribute visitors, rather than discord.gg/xnephilim
        ...
        <MainNavLink
          ...
          isExternal
          href='https://xnephilim.notion.site/Submit-Feedback-or-a-Feature-Request-af48a25fea574da4a05a980c347c055b'
        />
      </Stack>
    </Flex>
  )
