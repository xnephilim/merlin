...
import { merlinAssetId, merlinxAssetId, fromAssetId } from '@shapeshiftoss/caip'
import qs from 'qs'
      ...
      !asset
        ...
        : lpOpportunities.concat(stakingOpportunities).filter(
            row =>
              ...
              // show merlinx opportunity in the merlinx asset page
              (row.assetId === merlinAssetId && asset.assetId === merlinxAssetId),
          ),
