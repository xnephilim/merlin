...
const validators = {
  ...
  REACT_APP_BOARDROOM_API_BASE_URL: url({
    default: 'https://api.boardroom.info/v1/protocols/xnephilim/',
  }),
  REACT_APP_BOARDROOM_APP_BASE_URL: url({
    default: 'https://boardroom.io/xnephilim/',
  }),
  ...
  REACT_APP_COSMOS_NODE_URL: url({
    default: 'https://dev-daemon.osmosis.xnephilim.com',
  }),
  REACT_APP_OSMOSIS_NODE_URL: url({
    default: 'https://dev-daemon.cosmos.xnephilim.com',
  }),
  ...
  REACT_APP_OSMOSIS_LCD_BASE_URL: url({
    default: 'https://daemon.osmosis.xnephilim.com/',
  }),
  ...
  REACT_APP_SNAPSHOT_BASE_URL: url({
    default: 'https://snapshot.org/#/xnephilimdao.eth',
  }),
