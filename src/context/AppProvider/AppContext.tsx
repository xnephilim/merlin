...
export const AppProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    ;(async () => {
      ...
      const { getMerlinxRebaseHistoryByAccountId } = txHistoryApi.endpoints
      ...
      requestedAccountIds.forEach(accountId => {
        ...
        switch (chainId) {
          ...
          case ethChainId:
            ...
            /**
             * fetch all rebase history for merlinx
             *
             * merlinx rebase history is most closely linked to transactions.
             ...
             */
            dispatch(getMerlinxRebaseHistoryByAccountId.initiate({ accountId, portfolioAssetIds }))
            break
          default:
        }
      })
  ...
  useEffect(() => {
    ...
    // TODO(0xdef1cafe): bring polling back once we point at markets.xnephilim.com
