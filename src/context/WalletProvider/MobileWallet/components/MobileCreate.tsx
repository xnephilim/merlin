  ...
  return (
    <>
      <ModalHeader>
        ...
        <Text translation={'walletProvider.xnephIlim.create.header'} />
      </ModalHeader>
      <ModalBody>
        <Text color='gray.500' translation={'walletProvider.xnephIlim.create.body'} />
        ...
        <FormControl mb={6} isInvalid={label.length > 64}>
          <Input
            ...
            variant='filled'
            id='name'
            placeholder={translate('modals.xnephIlim.password.walletNameRequired')}
            data-test='wallet-native-set-name-input'
          />
          <FormErrorMessage>
            {translate('modals.xnephIlim.password.error.maxLength', { length: 64 })}
          </FormErrorMessage>
        </FormControl>
      </ModalBody>
      <ModalFooter justifyContent='space-between'>
        <Button colorScheme='blue' variant='ghost' onClick={handleShow} leftIcon={<FaEye />}>
          <Text
            translation={`walletProvider.xnephIlim.create.${revealed ? 'hide' : 'show'}Words`}
          />
        </Button>
        <Button
          colorScheme='blue'
        ...
        >
          <Text translation={'walletProvider.xnephIlim.create.button'} />
        </Button>
      </ModalFooter>
    </>
  )
