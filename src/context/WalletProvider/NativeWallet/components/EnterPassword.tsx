...
export const EnterPassword = () => {
  ...
  return (
    <>
      <ModalHeader>
        <Text translation={'modals.xnephIlim.password.header'} />
      </ModalHeader>
      <ModalBody>
        {state.isLoadingLocalWallet ? (
          ...
          <Text mb={6} color='gray.500' translation={'modals.xnephIlim.password.body'} />
        )}
        ...
        {state.isLoadingLocalWallet && (
          <Flex direction={['column', 'row']} mt={4} justifyContent='center' alignItems='center'>
            ...
            >
              {translate('walletProvider.xnephIlim.password.connect')}
            </Button>
          </Flex>
        )}
      </ModalBody>
