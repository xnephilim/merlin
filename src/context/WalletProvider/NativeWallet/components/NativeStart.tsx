...
export const NativeStart = ({ history }: RouteComponentProps) => {
  ...
  return (
    <>
      <ModalHeader>
        <Text translation={'walletProvider.xnephIlim.start.header'} />
      </ModalHeader>
      <ModalBody>
        <Text mb={4} color='gray.500' translation={'walletProvider.xnephIlim.start.body'} />
        <Stack mt={6} spacing={4}>
          ...
          >
            <Text translation={'walletProvider.xnephIlim.start.load'} />
          </Button>
          <Divider />
          <Button
            variant='ghost-filled'
          ...
          >
            <Text translation={'walletProvider.xnephIlim.start.create'} />
          </Button>
          <Button
            variant='ghost-filled'
            colorScheme='blue'
          ...
          >
            <Text translation={'walletProvider.xnephIlim.start.import'} />
          </Button>
          <Divider mt={4} />
          <Flex
            ...
            alignItems='center'
          >
            <Text translation={'walletProvider.xnephIlim.legacy.haveMobileWallet'} />
            <Button
              variant='link'
              ml={[0, 1.5]}
