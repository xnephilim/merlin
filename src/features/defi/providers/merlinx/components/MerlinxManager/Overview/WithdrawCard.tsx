...
import type { UserUndelegation } from 'state/slices/opportunitiesSlice/resolvers/merlinx/types'
...
export const WithdrawCard = ({ asset, undelegation, canClaimWithdraw }: WithdrawCardProps) => {
  ...
  return (
    <Stack px={8} py={6}>
      <Text fontWeight='medium' translation='defi.modals.merlinxOverview.withdrawals' />
      {!hasClaim ? (
        <Text color='gray.500' translation='defi.modals.merlinxOverview.emptyWithdraws' />
      ) : (
        <Button
          variant='input'
          width='full'
          ...
          >
            ...
            {isUndelegationAvailable ? (
              ...
              <Text
                ...
                lineHeight='shorter'
                translation={[
                  'defi.modals.merlinxOverview.availableDate',
