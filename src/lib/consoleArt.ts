export const renderConsoleArt = () => {
  ...
  console.info(
    `%c 💬 Join our Discord https://discord.gg/xnephilim`,
    'color: #3761F9; font-size: 12px; font-family: monospace',
  )
  console.info(
    `%c 📝 See the DAO overview https://app.boardroom.info/xnephilim/overview`,
    'color: #3761F9; font-size: 12px; font-family: monospace',
  )
  console.info(
    `%c 🧑‍💻 Contribute on GitHub https://github.com/xnephilim`,
    'color: #3761F9; font-size: 12px; font-family: monospace',
  )
  console.info(
    `%c
