...
const coinGeckoMarketApiUrl = 'https://markets.xnephilim.com/api/v3/coins/markets'
const coinGeckoMarketProApiUrl = 'https://markets.xnephilim.com/api/v3/coins/markets'
...
describe('CoinGecko market service', () => {
  describe('findAll', () => {
    ...
    it('extract correct values for merlin', async () => {
      ...
      const result = await coinGeckoMarketService.findAll()
      const merlinAssetId = adapters.coingeckoToAssetIds('xnephilim-merlin-token')[0]
