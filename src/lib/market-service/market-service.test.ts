...
const mockMerlinxFindAll = jest.fn().mockImplementation(() => mockMerlinxMarketData)
const mockMerlinxFindByAssetId = jest.fn().mockImplementation(() => mockMerlinxMarketData)
const mockMerlinxFindPriceHistoryByAssetId = jest
  .fn()
...
jest.mock('./merlinx/merlinx', () => ({
  MerlinxMarketService: jest.fn().mockImplementation(() => {
    return {
      findAll: mockMerlinxFindAll,
      findByAssetId: mockMerlinxFindByAssetId,
      findPriceHistoryByAssetId: mockMerlinxFindPriceHistoryByAssetId,
    }
  }),
}))
...
describe('market service', () => {
  ...
  describe('findAll', () => {
    ...
    it('errors if no data found', async () => {
      ...
      mockMerlinxFindAll.mockRejectedValueOnce({ error: 'error' })
  ...
  describe('findByAssetId', () => {
    ...
    it('can return null if no data found', async () => {
      ...
      mockMerlinxFindByAssetId.mockRejectedValueOnce({ error: 'error' })
  ...
  describe('findPriceHistoryByAssetId', () => {
    ...
    it('can return null if no data found', async () => {
      ...
      mockMerlinxFindPriceHistoryByAssetId.mockRejectedValueOnce({ error: 'error' })
