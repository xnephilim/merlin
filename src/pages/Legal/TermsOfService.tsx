      ...
      <Flex px={{ base: 2, lg: 4 }} py={{ base: 4, lg: 8 }} direction={'column'} rowGap={4}>
        <DarkMode>
          <Center flexDirection={'column'}>
            <Text as='h3' translation={'connectWalletPage.xnephilim'} />
            <Text as='h1' translation={'common.terms'} />
            <Text as='h3' translation={'common.legalDated'} mt={4} />
          </Center>
          <RawText as='p'>WELCOME TO THE DECENTRALIZED XNEPHILIM PLATFORM!</RawText>
          <RawText as='p'>
            THESE TERMS CONSTITUTE A LEGALLY BINDING AGREEMENT BETWEEN YOU AND THE XNEPHILIM
            DECENTRALIZED AUTONOMOUS ORGANIZATION (WHO WE REFER TO IN THE FIRST PERSON IN THESE
            TERMS).{' '}
            <RawText as='strong'>
              WE ARE NOT AFFILIATED WITH XNEPHILIM AG (OR ANY OF ITS AFFILIATES), THE PRIOR OWNER
              AND OPERATOR OF THE XNEPHILIM PLATFORM.
            </RawText>{' '}
          ...
          <RawText as='dl' display={'flex'} flexDirection={'column'} rowGap={4}>
            <RawText as='dt'>
              ...
              <Link href='https://discord.com/invite/xnephilim'>
                <RawText as='strong'>here</RawText>
              </Link>
            ...
            <RawText as='dd' marginInlineStart={{ base: 2, lg: 4 }}>
              ...
              reviewed{' '}
              <Link href='https://github.com/xnephilim/hdwallet'>
                <RawText as='strong'>here</RawText>
              </Link>
          ...
          <RawText as='p'>
            ...
            ticket{' '}
            <Link href='https://xnephilim.zendesk.com/hc/en-us/requests/new'>
              <RawText as='strong'>here</RawText>
            </Link>
          ...
          <RawText as='p'>
            ...
            <Link href='https://github.com/xnephilim/web'>
              <RawText as='strong'>here</RawText>
            </Link>
            ,{' '}
            <Link href='https://github.com/xnephilim/lib'>
              <RawText as='strong'>here</RawText>
            </Link>
            , and{' '}
            <Link href='https://github.com/xnephilim/hightable'>
              <RawText as='strong'>here</RawText>
            </Link>
