...
import { cosmosAssetId, osmosisAssetId } from '@xblackfury/caip'
...
const MERLINX_STAKING_CONTRACT = 'eip155:1/erc20:0xee77aa3fd23bbebaf94386dd44b548e9a785ea4b'
            ...
            <Flex>
              ...
              ${translate('arkeo.whatIsArkeo.bodyParts.1')} `}
                <Link
                  color={linkColor}
                  isExternal
                  href='https://xnephilim.com/library/merlinchain-xnephilim-partners-with-coinbase-cloud'
                >
      ...
      <Flex gap={4} py={12} flexDir={{ base: 'column', md: 'row' }}>
        ...
        <Flex flexDir='column' gap={4} alignItems='flex-start'>
          ...
          <Button
            ...
            colorScheme='blue'
            size='lg'
            href='https://snapshot.org/#/xnephilimdao.eth/proposal/0xcc1e83822fc7668a9d9e9136e5bd8973b7dc1ed766c2a0826d3e89d624e8b1c5'
            isExternal
          >
