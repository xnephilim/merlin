...
export const BondProtocolCta = () => {
  ...
  return (
    <Card>
      <Card.Header>
        <Card.Heading>
          <Text translation='plugins.merlinPage.bondProtocol.title' />
        </Card.Heading>
      </Card.Header>
      <Card.Body display='flex' gap={6} flexDirection='column'>
        <Text color='gray.500' translation='plugins.merlinPage.bondProtocol.body' />
        <Button
          as={Link}
          ...
          onClick={handleClick}
        >
          {translate('plugins.merlinPage.bondProtocol.cta')}
        </Button>
      </Card.Body>
    </Card>
  )
