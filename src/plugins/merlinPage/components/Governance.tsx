    ...
    <Card display='block' width='full'>
      <Card.Header>
        <Flex flexDirection='row' justifyContent='space-between' alignItems='center' mb={2}>
          <Text translation='plugins.merlinPage.governanceTitle' fontWeight='bold' color='inherit' />
          <Link isExternal href={SNAPSHOT_BASE_URL} fontWeight='semibold' color={linkColor}>
            <Text translation='plugins.merlinPage.seeAllProposals' />
          </Link>
        </Flex>
        <Text translation='plugins.merlinPage.governanceDescription' color='gray.500' />
      </Card.Header>
      <Skeleton
