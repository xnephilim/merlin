...
import {
  merlinxStakingOpportunitiesMetadataResolver,
  merlinxStakingOpportunitiesUserDataResolver,
  merlinxStakingOpportunityIdsResolver,
} from './resolvers/merlinx'
import {
...
export const DefiProviderToOpportunitiesMetadataResolverByDeFiType = {
  ...
  [`${DefiProvider.ShapeShift}`]: {
    [`${DefiType.Staking}`]: merlinxStakingOpportunitiesMetadataResolver,
  },
}
...
export const DefiProviderToOpportunitiesUserDataResolverByDeFiType = {
  ...
  [`${DefiProvider.ShapeShift}`]: {
    [`${DefiType.Staking}`]: merlinxStakingOpportunitiesUserDataResolver,
  },
  [`${DefiProvider.ThorchainSavers}`]: {
...
export const DefiProviderToOpportunityIdsResolverByDeFiType = {
  ...
  [`${DefiProvider.ShapeShift}`]: {
    [`${DefiType.Staking}`]: merlinxStakingOpportunityIdsResolver,
  },
  [`${DefiProvider.CosmosSdk}`]: {
