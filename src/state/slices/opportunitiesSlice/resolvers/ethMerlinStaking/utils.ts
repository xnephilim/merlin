...
export const makeTotalLpApr = (merlinRewardRatePerToken: string, merlinEquivalentPerLPToken: string) =>
  bnOrZero(merlinRewardRatePerToken) // Merlin Rewards per second for 1 staked LP token
    .div(merlinEquivalentPerLPToken) // Equivalent MERLIN value for 1 LP token
...
// Rate of MERLIN given per second for all staked addresses)
