...
import { fromAccountId, fromAssetId, toAccountId, toAssetId } from '@xblackfury/caip'
...
import type { MerlinxSpecificUserStakingOpportunity } from '../resolvers/merlinx/types'
import type {
  OpportunityId,
...
export const supportsUndelegations = (
  ...
  | CosmosSdkStakingSpecificUserStakingOpportunity
  | MerlinxSpecificUserStakingOpportunity => 'undelegations' in userStakingOpportunity
