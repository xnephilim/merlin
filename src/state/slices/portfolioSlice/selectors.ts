...
export const selectPortfolioTotalFiatBalanceExcludeEarnDupes = createSelector(
  selectPortfolioFiatBalances,
  (portfolioFiatBalances): string => {
    // ETH/MERLIN LP token and MERLINy are portfolio assets, but they're also part of DeFi opportunities
    ...
    const portfolioEarnAssetIdsDuplicates = [merlinEthLpAssetId, merlinxAssetId]
